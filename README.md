...
This repository contains the code and research findings for an ongoing project focused on developing effective betting strategies for English Premier League (EPL) games. Supervised by a Cornell statistics professor, the research involves extensive simulations and predictive modeling to explore profitable betting opportunities in soccer.
